...
> those files.  Scaffolding files are marked with a header comment that begins
> with `// scaffolding generated by 'threeport-sdk gen' …`.
>
> *Boilerplate*: generated source code that is not intended for modification and
> will be re-generated each time the `threeport-sdk gen` is run.  Boilerplate
> files are marked with a header comment that begins with
> `// boilerplate generated by 'threeport-sdk gen' …`.
