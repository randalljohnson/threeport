...
type AwsProvider struct {
	...
	AccountID *string `query:"accountid" gorm:"not null" validate:"required"`
	...
	AccessKeyID *string `validate:"optional" encrypt:"true"`

	// The secret key credentials for the AWS account.
	SecretAccessKey *string `validate:"optional" encrypt:"true"`

	// The RoleArn to assume for the AWS account.
	RoleArn *string `query:"rolearn" validate:"optional"`
	...
	ExternalId *string `query:"externalid" validate:"optional"`
...
type AwsEksKubernetesRuntimeInstance struct {
	...
	AwsEksKubernetesRuntimeDefinitionID *uint `query:"awsekskubernetesruntimedefinitionid" gorm:"not null" validate:"required" relationship:"requires"`
