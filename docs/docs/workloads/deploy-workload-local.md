...
```bash
curl -O https://raw.githubusercontent.com/threeport/threeport/0.7/samples/kubernetes-workload/wordpress-kubernetes-workload-local.yaml
```
...
```bash
curl -O https://raw.githubusercontent.com/threeport/threeport/0.7/samples/kubernetes-workload/wordpress-manifest-local.yaml
```
