...
type MachineRuntimeInstance struct {
	...
	IngressRules *[]IngressRule `validate:"optional" gorm:"type:jsonb;serializer:json"`
	...
	NetworkCIDR *string `validate:"optional" gorm:"column:network_cidr"`
	...
	SubnetCIDR *string `validate:"optional" gorm:"column:subnet_cidr"`
	...
	AssignPublicIP *bool `validate:"optional" gorm:"default:false"`
