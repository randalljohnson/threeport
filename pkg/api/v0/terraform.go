...
type TerraformInstance struct {
	...
	AwsProviderID *uint `query:"awsproviderid" gorm:"not null" validate:"required"`
	...
	TerraformDefinitionID *uint `query:"terraformdefinitionid" gorm:"not null" validate:"required"`
}
