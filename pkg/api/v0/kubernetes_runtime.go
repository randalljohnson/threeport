...
type KubernetesRuntimeDefinition struct {
	...
	// deployed on.
	InfraProviderAccountName *string `query:"infraprovideraccountname" validate:"optional"`
	...
	HighAvailability *bool `query:"highavailability" gorm:"default:false" validate:"optional"`

	// Sets the compute capacity of the machine type for the default node group.
	NodeSize *string `query:"nodesize" gorm:"default:Medium" validate:"optional"`

	// Sets the CPU:memory ration of the machine type for the default node
	// group.
	NodeProfile *string `query:"nodeprofile" gorm:"default:Balanced" validate:"optional"`

	// Sets the maximum number of nodes for the default node group.
	NodeMaximum *int `query:"nodemaximum" gorm:"default:250" validate:"optional"`
...
type KubernetesRuntimeInstance struct {
	...
	ThreeportControlPlaneHost *bool `query:"threeportcontrolplanehost" gorm:"default:false" validate:"optional"`
	...
	// otherwise assigned.
	DefaultRuntime *bool `query:"defaultruntime" gorm:"default:false" validate:"optional"`
