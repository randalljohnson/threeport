...
func AddLoggingDefinitionVersions() {
	apiserver_v0.LoggingDefinitionTaggedFields[string(api_v0.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
	...
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.LoggingDefinitionTaggedFields[string(api_v0.ValidateTag)]
...
func AddLoggingInstanceVersions() {
	apiserver_v0.LoggingInstanceTaggedFields[string(api_v0.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              string(api_v0.ValidateTag),
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.LoggingInstanceTaggedFields[string(api_v0.ValidateTag)]
...
func AddMetricsDefinitionVersions() {
	apiserver_v0.MetricsDefinitionTaggedFields[string(api_v0.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              string(api_v0.ValidateTag),
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.MetricsDefinitionTaggedFields[string(api_v0.ValidateTag)]
...
func AddMetricsInstanceVersions() {
	apiserver_v0.MetricsInstanceTaggedFields[string(api_v0.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              string(api_v0.ValidateTag),
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.MetricsInstanceTaggedFields[string(api_v0.ValidateTag)]
...
func AddObservabilityDashboardDefinitionVersions() {
	apiserver_v0.ObservabilityDashboardDefinitionTaggedFields[string(api_v0.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              string(api_v0.ValidateTag),
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.ObservabilityDashboardDefinitionTaggedFields[string(api_v0.ValidateTag)]
...
func AddObservabilityDashboardInstanceVersions() {
	apiserver_v0.ObservabilityDashboardInstanceTaggedFields[string(api_v0.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              string(api_v0.ValidateTag),
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.ObservabilityDashboardInstanceTaggedFields[string(api_v0.ValidateTag)]
...
func AddObservabilityStackDefinitionVersions() {
	apiserver_v0.ObservabilityStackDefinitionTaggedFields[string(api_v0.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              string(api_v0.ValidateTag),
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.ObservabilityStackDefinitionTaggedFields[string(api_v0.ValidateTag)]
...
func AddObservabilityStackInstanceVersions() {
	apiserver_v0.ObservabilityStackInstanceTaggedFields[string(api_v0.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              string(api_v0.ValidateTag),
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.ObservabilityStackInstanceTaggedFields[string(api_v0.ValidateTag)]
