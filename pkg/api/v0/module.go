...
type ModuleApi struct {
	...
	Name *string `query:"name" validate:"required" gorm:"not null;uniqueIndex:idx_module_api_identity"`

	// If true, represents the core Threeport API.
	Core *bool `query:"core" validate:"optional" gorm:"default:false"`

	// The reverse-DNS namespace identifying this module API (e.g. "example.com").
	ApiNamespace *string `query:"apinamespace" validate:"optional" gorm:"uniqueIndex:idx_module_api_identity"`
...
type ModuleApiRoute struct {
	...
	ModuleApiID *uint `query:"moduleapiid" validate:"required" gorm:"not null" relationship:"requires"`
...
type ModuleObject struct {
	...
	Description *string `query:"description" validate:"optional"`
	...
	ModuleControllerID *uint `query:"modulecontrollerid" validate:"optional" relationship:"requires"`
