...
func AddSecretDefinitionVersions() {
	apiserver_v0.SecretDefinitionTaggedFields[string(api_lib.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
	...
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.SecretDefinitionTaggedFields[string(api_lib.ValidateTag)]
...
func AddSecretInstanceVersions() {
	apiserver_v0.SecretInstanceTaggedFields[string(api_lib.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              string(api_lib.ValidateTag),
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.SecretInstanceTaggedFields[string(api_lib.ValidateTag)]
