...
func ObservabilityDashboardDefinitionReconciler(r *controller.Reconciler) {
	...
	for {
		...
		default:
			...
			if observabilityDashboardDefinition.ScheduledForDeletion() != nil && operation == notifications.NotificationOperationUpdated {
				log.Info("observability dashboard definition scheduled for deletion - treating update as delete")
			...
			case notifications.NotificationOperationCreated:
				...
				if owner, ok := observabilityDashboardDefinition.(api_v0.RelationshipTaggedForeignKeyProvider); ok {
				...
				if recordErr := r.EventsRecorder.RecordEvent(
					...
					observabilityDashboardDefinition.GetId(),
					observabilityDashboardDefinition.GetFullyQualifiedType(),
				); recordErr != nil {
