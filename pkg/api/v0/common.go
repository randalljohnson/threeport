...
type Reconciliation struct {
	...
	Reconciled *bool `json:",omitempty" query:"reconciled" gorm:"default:false" validate:"optional"`
	...
	// act accordingly.
	CreationAcknowledged *time.Time `json:",omitempty" query:"creationacknowledged" validate:"optional"`

	// Used by controllers to confirm deletion of an object.
	CreationConfirmed *time.Time `json:",omitempty" query:"creationconfirmed" validate:"optional"`

	// Gets set to true if creation process fails.
	CreationFailed *bool `json:",omitempty" query:"creationfailed" gorm:"default:false" validate:"optional"`
	...
	DeletionScheduled *time.Time `json:",omitempty" query:"deletionscheduled" validate:"optional"`

	// Used by controllers to acknowledge deletion and indicate that deletion
	// reconciliation has begun so that subsequent reconciliation attempts can
	// act accordingly.
	DeletionAcknowledged *time.Time `json:",omitempty" query:"deletionacknowledged" validate:"optional"`

	// Used by controllers to confirm deletion of an object.
	DeletionConfirmed *time.Time `json:",omitempty" query:"deletionconfirmed" validate:"optional"`
	...
	InterruptReconciliation *bool `json:",omitempty" query:"interruptreconciliation" gorm:"default:false" validate:"optional"`
}
