		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				case "v0":
					...
					operationErr = err
				default:
					operationErr = errors.New("unrecognized version of logging definition encountered for create operation")
				}
				if operationErr != nil {
					if errors.Is(operationErr, tpclient_lib.ErrConflict) {
						log.V(1).Info(
							"logging definition create deferred pending in-flight deletion, requeueing",
			...
			case notifications.NotificationOperationUpdated:
				...
				case "v0":
					...
					operationErr = err
				default:
					operationErr = errors.New("unrecognized version of logging definition encountered for update operation")
				}
				if operationErr != nil {
					if errors.Is(operationErr, tpclient_lib.ErrConflict) {
						log.V(1).Info(
							"logging definition update deferred pending in-flight deletion, requeueing",
							"cause", operationErr.Error(),
						)
						r.UnlockAndRequeue(
							loggingDefinition,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					if errors.Is(operationErr, tpclient_lib.ErrConflict) {
						log.V(1).Info(
							"logging definition delete deferred pending in-flight deletion, requeueing",
							"cause", operationErr.Error(),
						)
						r.UnlockAndRequeue(
							loggingDefinition,
				...
				if err != nil {
					if errors.Is(err, tpclient_lib.ErrConflict) {
						log.V(1).Info(
							"logging definition deletion already in progress, requeueing",
							"cause", err.Error(),
						)
						r.UnlockAndRequeue(
							loggingDefinition,
