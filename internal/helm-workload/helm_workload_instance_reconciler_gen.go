...
func HelmWorkloadInstanceReconciler(r *controller.Reconciler) {
	...
	for {
		...
		default:
			...
			if helmWorkloadInstance.ScheduledForDeletion() != nil && operation == notifications.NotificationOperationUpdated {
				log.Info("helm workload instance scheduled for deletion - treating update as delete")
			...
			case notifications.NotificationOperationCreated:
				...
				if owner, ok := helmWorkloadInstance.(api_v0.RelationshipTaggedForeignKeyProvider); ok {
				...
				if recordErr := r.EventsRecorder.RecordEvent(
					...
					helmWorkloadInstance.GetId(),
					helmWorkloadInstance.GetFullyQualifiedType(),
				); recordErr != nil {
				...
				case "v0":
					...
					operationErr = err
				default:
					operationErr = errors.New("unrecognized version of helm workload instance encountered for create operation")
				}
				if operationErr != nil {
			...
			case notifications.NotificationOperationUpdated:
				if helmWorkloadInstance.ScheduledForDeletion() != nil {
					log.Info("helm workload instance scheduled for deletion - skipping update")
					break
				}
				// record in-progress before the custom handler so a later failure still has a start event
				...
				case "v0":
					...
					operationErr = err
				default:
					operationErr = errors.New("unrecognized version of helm workload instance encountered for update operation")
				}
				if operationErr != nil {
			...
			case notifications.NotificationOperationDeleted:
				...
				case "v0":
					...
					operationErr = err
				default:
					operationErr = errors.New("unrecognized version of helm workload instance encountered for delete operation")
				}
				if operationErr != nil {
