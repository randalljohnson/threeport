    ...
    "definitions": {
        ...
        "v0.MachineWorkloadDefinition": {
            ...
            "properties": {
                ...
                "Env": {
                    "description": "The environment variables to set for the workload in KEY=VALUE format.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "v0.MachineWorkloadInstance": {
            ...
            "properties": {
                ...
                "Env": {
                    "description": "The environment variables set for the workload in KEY=VALUE format.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "Status": {
                    "description": "The latest status of the kubernetes workload instance.",
                    "type": "string"
                }
            }
        },
