...
func AddAwsEksKubernetesRuntimeDefinitionVersions() {
	apiserver_v0.AwsEksKubernetesRuntimeDefinitionTaggedFields[string(api_lib.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
	...
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.AwsEksKubernetesRuntimeDefinitionTaggedFields[string(api_lib.ValidateTag)]
...
func AddAwsEksKubernetesRuntimeInstanceVersions() {
	apiserver_v0.AwsEksKubernetesRuntimeInstanceTaggedFields[string(api_lib.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              string(api_lib.ValidateTag),
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.AwsEksKubernetesRuntimeInstanceTaggedFields[string(api_lib.ValidateTag)]
...
func AddAwsProviderVersions() {
	apiserver_v0.AwsProviderTaggedFields[string(api_lib.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              string(api_lib.ValidateTag),
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.AwsProviderTaggedFields[string(api_lib.ValidateTag)]
