...
type OciOkeKubernetesRuntimeInstance struct {
	...
	OciProviderID *uint `query:"ociproviderid" gorm:"not null" validate:"required" relationship:"requires"`
	...
	OciOkeKubernetesRuntimeDefinitionID *uint `query:"ociokekubernetesruntimedefinitionid" gorm:"not null" validate:"required" relationship:"requires"`
	...
	ClusterOCID *string `query:"clusterocid" validate:"optional"`
}
