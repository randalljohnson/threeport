...
func AddAttachedObjectReferenceVersions() {
	apiserver_v0.AttachedObjectReferenceTaggedFields[string(api_v0.ValidateTag)] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
	...
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.AttachedObjectReferenceTaggedFields[string(api_v0.ValidateTag)]
