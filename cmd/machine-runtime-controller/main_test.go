...
const helperEnvVar = "MACHINE_RUNTIME_CTRL_HELP_EXIT_CODE"
...
const mainHelpEnvVar = "MACHINE_RUNTIME_CTRL_MAIN_HELP"
...
func TestMain(m *testing.M) {
	...
	if _, ok := os.LookupEnv(mainHelpEnvVar); ok {
		os.Args = []string{"threeport-machine-runtime-controller", "-help"}
		main()
...
func TestShowHelpAndExitPrintsUsage(t *testing.T) {
	...
	wantPrefix := "Usage: threeport-machine-runtime-controller [options]"
