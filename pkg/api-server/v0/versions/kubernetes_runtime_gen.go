...
func AddKubernetesRuntimeDefinitionVersions() {
	apiserver_v0.KubernetesRuntimeDefinitionTaggedFields[sdk.ValidateTag] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
	...
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.KubernetesRuntimeDefinitionTaggedFields[sdk.ValidateTag]
...
func AddKubernetesRuntimeInstanceVersions() {
	apiserver_v0.KubernetesRuntimeInstanceTaggedFields[sdk.ValidateTag] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              sdk.ValidateTag,
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.KubernetesRuntimeInstanceTaggedFields[sdk.ValidateTag]
