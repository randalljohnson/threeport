...
func AddEventVersions() {
	apiserver_v0.EventTaggedFields[sdk.ValidateTag] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
	...
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.EventTaggedFields[sdk.ValidateTag]
