...
type AwsProvider struct {
	...
	RoleArn *string `json:",omitempty" query:"rolearn" validate:"optional"`
	...
	ExternalId *string `json:",omitempty" query:"externalid" validate:"optional"`
...
type AwsEksKubernetesRuntimeInstance struct {
	...
	AwsEksKubernetesRuntimeDefinitionID *uint `query:"awsekskubernetesruntimedefinitionid" gorm:"not null" validate:"required"`
