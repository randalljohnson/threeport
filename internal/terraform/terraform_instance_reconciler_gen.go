...
func TerraformInstanceReconciler(r *controller.Reconciler) {
	...
	for {
		...
		default:
			...
			if terraformInstance.ScheduledForDeletion() != nil && operation == notifications.NotificationOperationUpdated {
				log.Info("terraform instance scheduled for deletion - treating update as delete")
			...
			case notifications.NotificationOperationCreated:
				...
				case "v0":
					...
					operationErr = err
				default:
					operationErr = errors.New("unrecognized version of terraform instance encountered for create operation")
				}
				if operationErr != nil {
			...
			case notifications.NotificationOperationUpdated:
				...
				case "v0":
					...
					operationErr = err
				default:
					operationErr = errors.New("unrecognized version of terraform instance encountered for update operation")
				}
				if operationErr != nil {
