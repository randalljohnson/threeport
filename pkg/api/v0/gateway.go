...
type GatewayDefinition struct {
	...
	HttpPorts []*GatewayHttpPort `json:",omitempty" query:"httpports" validate:"optional"`

	// TcpPorts is a list of TCP ports to expose to the outside network.
	TcpPorts []*GatewayTcpPort `json:",omitempty" query:"tcpports" validate:"optional"`

	// The domain name to serve requests for.
	DomainNameDefinitionID *uint `json:",omitempty" query:"domainnamedefinitionid" validate:"optional"`

	// An optional subdomain to add to the domain name.
	SubDomain *string `json:",omitempty" query:"subdomain" validate:"optional"`

	// The kubernetes service to route requests to.
	ServiceName *string `json:",omitempty" query:"servicename" validate:"optional"`

	// The workload definition that belongs to this resource.
	WorkloadDefinitionID *uint `json:",omitempty" query:"workloaddefinitionid" validate:"optional"`
...
type GatewayHttpPort struct {
	...
	Path *string `json:",omitempty" query:"path" gorm:"default:'/'" validate:"optional"`

	// Indicates if TLS is enabled.
	TLSEnabled *bool `json:",omitempty" query:"tlsenabled" gorm:"default:false" validate:"optional"`

	// Redirect all requests to HTTP port to HTTPS.
	HTTPSRedirect *bool `json:",omitempty" query:"httpsredirect" gorm:"default:false" validate:"optional"`
}
...
type DomainNameInstance struct {
	...
	DomainNameDefinitionID *uint `query:"domainnamedefinitionid" gorm:"not null" validate:"required"`
