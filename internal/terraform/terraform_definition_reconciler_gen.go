...
func TerraformDefinitionReconciler(r *controller.Reconciler) {
	...
	for {
		...
		default:
			...
			if terraformDefinition.ScheduledForDeletion() != nil && operation == notifications.NotificationOperationUpdated {
				log.Info("terraform definition scheduled for deletion - treating update as delete")
			...
			case notifications.NotificationOperationCreated:
				...
				if owner, ok := terraformDefinition.(api_v0.RelationshipTaggedForeignKeyProvider); ok {
