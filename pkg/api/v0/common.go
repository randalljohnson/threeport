...
type Reconciliation struct {
	...
	CreationFailed *bool `json:",omitempty" gorm:"default:false" validate:"optional"`
	...
	InterruptReconciliation *bool `json:",omitempty" gorm:"default:false" validate:"optional"`
}
