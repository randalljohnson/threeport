...
type GatewayDefinition struct {
	...
	// Public *bool `query:"public" gorm:"default:true" validate:"optional"`

	// // Allow requests from the private network outside the workload cluster but
	// // not from the public internet.
	// Private *bool `query:"private" gorm:"default:false"
	// validate:"optional"`
	...
	DomainNameDefinitionID *uint `query:"domainnamedefinitionid" validate:"optional"`

	// An optional subdomain to add to the domain name.
	SubDomain *string `query:"subdomain" validate:"optional"`

	// The kubernetes service to route requests to.
	ServiceName *string `query:"servicename" validate:"optional"`

	// The workload definition that belongs to this resource.
	WorkloadDefinitionID *uint `query:"workloaddefinitionid" validate:"optional"`
...
type GatewayInstance struct {
	...
	// DomainNameInstanceID *uint `query:"domainnameinstanceid" validate:"optional"`

	// GatewayDefinitionID is the definition used to configure the gateway instance.
	GatewayDefinitionID *uint `query:"gatewaydefinitionid" gorm:"not null" validate:"required" relationship:"requires"`
	...
	// WorkloadResourceInstances *[]WorkloadResourceInstance `query:"workloadresourceinstances" validate:"optional,association"`

	// The workload instance this gateway belongs to.
	WorkloadInstanceID *uint `query:"workloadinstanceid" gorm:"not null" validate:"required" relationship:"requires"`
}
...
type GatewayHttpPort struct {
	...
	GatewayDefinitionID *uint `query:"gatewaydefinitionid" gorm:"not null" validate:"required"`

	// The HTTP port to expose.
	Port *int `query:"port" gorm:"not null" validate:"required"`

	// The request path to serve requests for.
	Path *string `query:"path" gorm:"default:'/'" validate:"optional"`

	// Indicates if TLS is enabled.
	TLSEnabled *bool `query:"tlsenabled" gorm:"default:false" validate:"optional"`

	// Redirect all requests to HTTP port to HTTPS.
	HTTPSRedirect *bool `query:"httpsredirect" gorm:"default:false" validate:"optional"`
}
...
type DomainNameDefinition struct {
	...
	Domain *string `query:"domain" gorm:"not null" validate:"required"`

	// The name of the zone in which the domain is managed.
	Zone *string `query:"zone" gorm:"not null" validate:"required"`

	// The email address of the domain administrator.
	AdminEmail *string `query:"adminemail" gorm:"not null" validate:"required"`

	// Whether or not the domain name is a root domain.
	// RootDomain *bool `query:"rootdomain" gorm:"default:false" validate:"optional"`

	// TTL configuration for this record.
	// TTL *uint `query:"ttl" gorm:"default:300" validate:"optional"`

	// The type of DNS record to create.
	// Type *string `query:"type" gorm:"default:'A'"
	// validate:"optional"`
...
type DomainNameInstance struct {
	...
	DomainNameDefinitionID *uint `query:"domainnamedefinitionid" gorm:"not null" validate:"required" relationship:"requires"`
