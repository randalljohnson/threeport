...
func main() {
	...
	controller.WaitForStream(js, notif.MachineRuntimeStreamName, log)
	...
	for _, r := range reconcilerConfigs {
		...
		consumerInfo, err := notifications.EnsureConsumer(js, notif.MachineRuntimeStreamName, consumerConfig)
		if err != nil {
