...
`docs/dev/style-guide.md` holds the Go conventions: imports, commit messages, code
comments, and naming. Splitting them further into per-path rule files that load only
for the files they govern is planned and has not landed, so read the relevant page
under `docs/dev/` instead.

<!-- begin boilerplate generated by 'mage dev:generateAgentsIndex' - do not edit -->
...
<!-- end boilerplate generated by 'mage dev:generateAgentsIndex' - do not edit -->
