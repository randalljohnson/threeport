		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				case "v0":
					...
					operationErr = err
				default:
					operationErr = errors.New("unrecognized version of control plane definition encountered for create operation")
				}
				if operationErr != nil {
					if errors.Is(operationErr, tpclient_lib.ErrConflict) {
						log.V(1).Info(
							"control plane definition create deferred pending in-flight deletion, requeueing",
			...
			case notifications.NotificationOperationUpdated:
				...
				case "v0":
					...
					operationErr = err
				default:
					operationErr = errors.New("unrecognized version of control plane definition encountered for update operation")
				}
				if operationErr != nil {
					if errors.Is(operationErr, tpclient_lib.ErrConflict) {
						log.V(1).Info(
							"control plane definition update deferred pending in-flight deletion, requeueing",
							"cause", operationErr.Error(),
						)
						r.UnlockAndRequeue(
							controlPlaneDefinition,
			...
			case notifications.NotificationOperationDeleted:
				...
				case "v0":
					...
					operationErr = err
				default:
					operationErr = errors.New("unrecognized version of control plane definition encountered for delete operation")
				}
				if operationErr != nil {
					if errors.Is(operationErr, tpclient_lib.ErrConflict) {
						log.V(1).Info(
							"control plane definition delete deferred pending in-flight deletion, requeueing",
							"cause", operationErr.Error(),
						)
						r.UnlockAndRequeue(
							controlPlaneDefinition,
				...
				if err != nil {
					if errors.Is(err, tpclient_lib.ErrConflict) {
						log.V(1).Info(
							"control plane definition deletion already in progress, requeueing",
							"cause", err.Error(),
						)
						r.UnlockAndRequeue(
							controlPlaneDefinition,
