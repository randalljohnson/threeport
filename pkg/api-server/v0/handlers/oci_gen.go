...
func (h Handler) AddOciOkeKubernetesRuntimeDefinition(c echo.Context) error {
	...
	if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
		return h.RequestDB(c).Create(&ociOkeKubernetesRuntimeDefinition)
	}); result.Error != nil {
...
func (h Handler) GetOciOkeKubernetesRuntimeDefinitions(c echo.Context) error {
	...
	case pageParams.QueryId == "":
		...
		case true:
			...
			queryId, count, err := h.DispatchGetPaginatedRecords(h.RequestDB(c).Model(&api_v0.OciOkeKubernetesRuntimeDefinition{}).Where(&filter), records, queryTable, pageParams)
			if err != nil {
...
func (h Handler) UpdateOciOkeKubernetesRuntimeDefinition(c echo.Context) error {
	...
	if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
		return h.RequestDB(c).Model(&existingOciOkeKubernetesRuntimeDefinition).Updates(&updatedOciOkeKubernetesRuntimeDefinition)
	}); result.Error != nil {
...
func (h Handler) ReplaceOciOkeKubernetesRuntimeDefinition(c echo.Context) error {
	...
	if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
		return h.RequestDB(c).Session(&gorm.Session{FullSaveAssociations: false}).Omit("CreatedAt", "DeletedAt").Save(&updatedOciOkeKubernetesRuntimeDefinition)
	}); result.Error != nil {
...
// @Description Cascade: deleting a oci oke kubernetes runtime definition also removes the attached object reference rows it holds as the attacher, in the same transaction. The objects those references point at are not deleted.
...
func (h Handler) DeleteOciOkeKubernetesRuntimeDefinition(c echo.Context) error {
	...
	// delete object
	if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
		return h.RequestDB(c).Delete(&ociOkeKubernetesRuntimeDefinition)
	}); result.Error != nil {
...
func (h Handler) AddOciOkeKubernetesRuntimeInstance(c echo.Context) error {
	...
	// persist to DB
	if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
		return h.RequestDB(c).Create(&ociOkeKubernetesRuntimeInstance)
	}); result.Error != nil {
		h.Logger.Error("handler error: error creating object", zap.Error(result.Error))
		// check if this is a custom HTTP error with specific status code
		var httpErr *util_v0.HttpError
...
func (h Handler) GetOciOkeKubernetesRuntimeInstances(c echo.Context) error {
	...
	case pageParams.QueryId == "":
		...
		case true:
			// dispatch to the configured pagination strategy to fetch the first page
			queryTable := filter.TableName()
			queryId, count, err := h.DispatchGetPaginatedRecords(h.RequestDB(c).Model(&api_v0.OciOkeKubernetesRuntimeInstance{}).Where(&filter), records, queryTable, pageParams)
			if err != nil {
				if errors.Is(err, apiserver_lib.ErrInvalidPaginationQueryId) || errors.Is(err, apiserver_lib.ErrPaginationSessionExpired) {
					return apiserver_lib.ResponseStatus400(c, pageParams, err, objectType)
				}
...
func (h Handler) UpdateOciOkeKubernetesRuntimeInstance(c echo.Context) error {
	...
	// update object in database
	if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
		return h.RequestDB(c).Model(&existingOciOkeKubernetesRuntimeInstance).Updates(&updatedOciOkeKubernetesRuntimeInstance)
	}); result.Error != nil {
		h.Logger.Error("handler error: error updating object", zap.Error(result.Error))
		// check if this is a custom HTTP error with specific status code
		var httpErr *util_v0.HttpError
...
func (h Handler) ReplaceOciOkeKubernetesRuntimeInstance(c echo.Context) error {
	...
	if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
		return h.RequestDB(c).Session(&gorm.Session{FullSaveAssociations: false}).Omit("CreatedAt", "DeletedAt").Save(&updatedOciOkeKubernetesRuntimeInstance)
	}); result.Error != nil {
		h.Logger.Error("handler error: error persisting object", zap.Error(result.Error))
		// check if this is a custom HTTP error with specific status code
		var httpErr *util_v0.HttpError
...
// @Description Cascade: deleting a oci oke kubernetes runtime instance also removes the attached object reference rows it holds as the attacher, in the same transaction. The objects those references point at are not deleted.
...
func (h Handler) DeleteOciOkeKubernetesRuntimeInstance(c echo.Context) error {
	...
	if ociOkeKubernetesRuntimeInstance.DeletionScheduled == nil {
		...
		if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
			return h.RequestDB(c).Model(&ociOkeKubernetesRuntimeInstance).Updates(&scheduledOciOkeKubernetesRuntimeInstance)
		}); result.Error != nil {
		...
		if ociOkeKubernetesRuntimeInstance.DeletionConfirmed == nil {
			...
			// from DB
			if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
				return h.RequestDB(c).Delete(&ociOkeKubernetesRuntimeInstance)
			}); result.Error != nil {
				h.Logger.Error("handler error: error deleting object", zap.Error(result.Error))
...
func (h Handler) AddOciProvider(c echo.Context) error {
	...
	// persist to DB
	if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
		return h.RequestDB(c).Create(&ociProvider)
	}); result.Error != nil {
		h.Logger.Error("handler error: error creating object", zap.Error(result.Error))
		// check if this is a custom HTTP error with specific status code
		var httpErr *util_v0.HttpError
...
func (h Handler) GetOciProviders(c echo.Context) error {
	...
	case pageParams.QueryId == "":
		...
		case true:
			// dispatch to the configured pagination strategy to fetch the first page
			queryTable := filter.TableName()
			queryId, count, err := h.DispatchGetPaginatedRecords(h.RequestDB(c).Model(&api_v0.OciProvider{}).Where(&filter), records, queryTable, pageParams)
			if err != nil {
				if errors.Is(err, apiserver_lib.ErrInvalidPaginationQueryId) || errors.Is(err, apiserver_lib.ErrPaginationSessionExpired) {
					return apiserver_lib.ResponseStatus400(c, pageParams, err, objectType)
				}
...
func (h Handler) UpdateOciProvider(c echo.Context) error {
	...
	// update object in database
	if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
		return h.RequestDB(c).Model(&existingOciProvider).Updates(&updatedOciProvider)
	}); result.Error != nil {
		h.Logger.Error("handler error: error updating object", zap.Error(result.Error))
		// check if this is a custom HTTP error with specific status code
		var httpErr *util_v0.HttpError
...
func (h Handler) ReplaceOciProvider(c echo.Context) error {
	...
	if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
		return h.RequestDB(c).Session(&gorm.Session{FullSaveAssociations: false}).Omit("CreatedAt", "DeletedAt").Save(&updatedOciProvider)
	}); result.Error != nil {
		h.Logger.Error("handler error: error persisting object", zap.Error(result.Error))
		// check if this is a custom HTTP error with specific status code
		var httpErr *util_v0.HttpError
...
// @Description Cascade: deleting a oci provider also removes the attached object reference rows it holds as the attacher, in the same transaction. The objects those references point at are not deleted.
...
func (h Handler) DeleteOciProvider(c echo.Context) error {
	...
	// delete object
	if result := apiserver_lib.RetryOnSerializationFailure(func() *gorm.DB {
		return h.RequestDB(c).Delete(&ociProvider)
	}); result.Error != nil {
		h.Logger.Error("handler error: error deleting object", zap.Error(result.Error))
		// surface BlockedDeleteError from gorm hook - sole blocking check for non-reconciled types
		var blockedErr *api_v0.BlockedDeleteError
