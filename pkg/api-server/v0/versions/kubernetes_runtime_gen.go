...
func AddKubernetesRuntimeDefinitionVersions() {
	apiserver_v0.KubernetesRuntimeDefinitionTaggedFields[v0.ValidateTag] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
	...
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.KubernetesRuntimeDefinitionTaggedFields[v0.ValidateTag]
...
func AddKubernetesRuntimeInstanceVersions() {
	apiserver_v0.KubernetesRuntimeInstanceTaggedFields[v0.ValidateTag] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
		OptionalAssociations: []string{},
		Required:             []string{},
		TagName:              v0.ValidateTag,
	...
	// add the object tagged fields to the global tagged fields map
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.KubernetesRuntimeInstanceTaggedFields[v0.ValidateTag]
