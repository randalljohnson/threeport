...
func AddEventVersions() {
	apiserver_v0.EventTaggedFields[v0.ValidateTag] = &apiserver_lib.FieldsByTag{
		Optional:             []string{},
	...
	apiserver_lib.ObjectTaggedFields[versionObj] = apiserver_v0.EventTaggedFields[v0.ValidateTag]
